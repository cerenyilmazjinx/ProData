...
#[derive(Debug)]
pub struct ProDataProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ProDataProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ProData processing");
    
    let mut processor = ProDataProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ProDataProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ProDataProcessor::new(false);
